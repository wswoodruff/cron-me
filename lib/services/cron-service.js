...
module.exports = class CronMeService extends Schmervice.Service {
    ...
    async runCrons() {
        ...
        const intervalFirstRuns = await Cron.query()
            ...
            // Avoid missed runs
            .whereRaw('?? + ??::interval + interval \'5 minutes\' > now()', ['createdAt', 'cronExpression']);
        ...
        const intervalRepeatRuns = await Cron.query()
            ...
            // Avoid missed runs
            .whereRaw('?? + ??::interval + interval \'5 minutes\' > now()', ['lastRunAt', 'cronExpression']);
    ...
    async create({ name, cronExpression, details, enabled }) {
        ...
        // TODO determine type of 'cronExpression'
        // Either 'interval' or 'datetime'
